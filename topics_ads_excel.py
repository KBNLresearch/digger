...
SRU_QUERY += 'type exact "advertentie" and '
...
COLNAMES = ['url', 'topic', 'media and communication', 'financial and banking', 'construction', 'culture and leisure', 'education', 'real estate', 'food', 'medical', 'wearing apparel', 'transport', 'religious', 'other manufectured goods', 'ocr']
