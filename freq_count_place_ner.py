...
if __name__ == '__main__':
    ...
    #atype: artikel, ppn: 37631091X, place: Kampen, date: 1938, hits_string: 100, hits_ner: 58
    #print(len(exec_query("37631091X", "Kampen", "1938", "artikel", 0, [])))
        ...
        #        continue
            for date in WANTED_RANGES:
                for atype in WANTED_TYPES:
                    ...
                    #    except:
                    #        time.sleep(random.random())
                    print("atype: %s, ppn: %s, place: %s, date: %s, hits_string: %s" % (atype, ppn, place, date, total_hits))
